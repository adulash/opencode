...
import { DebugBar, debugBarShown } from "@/components/debug-bar"
              ...
              <div class="shrink-0 ps-1 py-1">
                <div class="group/project flex items-start justify-between gap-2 py-2 ps-2 pe-0">
                  <div class="flex flex-col min-w-0">
                    ...
                    >
                      <span dir="ltr" class="text-12-regular text-text-base truncate select-text">
          ...
          <div class="size-full relative overflow-x-hidden">
            ...
            <div class="xl:hidden">
              ...
              <nav
                ...
                classList={{
                  ...
                  "-translate-x-full rtl:translate-x-full": !layout.mobileSidebar.opened(),
                }}
            ...
            <div
              classList={{
                ...
                "opacity-0 -translate-x-2 rtl:translate-x-2": !state.peeked || layout.sidebar.opened(),
                "transition-[opacity,transform] motion-reduce:transition-none": true,
                "duration-180 ease-out": state.peeked && !layout.sidebar.opened(),
                "duration-120 ease-in": !state.peeked || layout.sidebar.opened(),
              }}
