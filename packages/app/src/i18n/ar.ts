export const dict = {
  ...
  "agent.name.build": "تنفيذ",
  "agent.name.plan": "تخطيط",
  ...
  "session.child.promptDisabled": "لا يمكن إرسال موجهات إلى جلسات الوكيل الفرعي.",
  ...
  "session.review.noUncommittedChanges": "لا توجد تغييرات غير مودعة بعد",
  ...
  "settings.general.row.terminalFont.title": "خط المحطة الطرفية",
  "settings.general.row.terminalFont.description": "خصّص الخط المستخدم في المحطة الطرفية",
  ...
  "settings.general.row.shell.description":
    "اختر الـ shell المستخدم في المحطة الطرفية. تُستخدم أنواع shell المتوافقة أيضًا لاستدعاءات أدوات الوكيل.",
  ...
  "settings.general.row.showFileTree.description": "إظهار مفتاح ولوحة شجرة الملفات في جلسات سطح المكتب",
  "settings.general.row.showNavigation.title": "عناصر التنقل",
  "settings.general.row.showNavigation.description": "إظهار زرّي الرجوع والتقدم في شريط عنوان سطح المكتب",
  ...
  "settings.general.row.showStatus.description": "إظهار زر حالة الخادم في شريط عنوان سطح المكتب",
