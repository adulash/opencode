export const dict = {
  ...
  "ui.sessionTurn.diffs.changed.one": "تم تعديل ملف واحد",
  "ui.sessionTurn.diffs.changed.other": "تم تعديل {{count}} من الملفات",
  "ui.sessionTurn.diffs.showAll": "إظهار الكل",
  "ui.sessionTurn.diffs.showLess": "إظهار أقل",
  "ui.sessionTurn.diffs.more": "+{{count}} من الملفات الإضافية",
